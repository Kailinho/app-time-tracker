...
function WebsiteUsage() {
  ...
  const [reportPeriod, setReportPeriod] = useState(1); // Default: Daily
  ...
  const getChartData = (data, period) => {
    ...
    dates.forEach((date) => {
      Object.entries(data[date] || {}).forEach(([domain, times]) => {
        ...
        aggregatedData[domain].activeTime += times.activeTime || times;
        aggregatedData[domain].backgroundTime += times.backgroundTime || 0;
      });
    });
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-white p-4">
      ...
      <h2 className="text-xl font-semibold mt-8">Detailed Website Usage Data</h2>
